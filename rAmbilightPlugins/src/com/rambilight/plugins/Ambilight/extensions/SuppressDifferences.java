...
public class SuppressDifferences extends ColorAlgorithm {
    ...
    public void savePreferences(Preferences preferences) {
        preferences.save("colorAlgorithm.Suppressed.colorSuppress", colorSuppress);
    }

    public void loadPreferences(Preferences preferences) {
        colorSuppress = preferences.load("colorAlgorithm.Suppressed.colorSuppress", colorSuppress);
    }
}
