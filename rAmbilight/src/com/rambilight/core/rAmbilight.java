...
public class rAmbilight {
	...
	public void loadDebugger(Class<? extends Module> debugModule) {
		load(SerialControllerLocal.class, debugModule);
	}
	...
	public void load(Class<? extends Module> debugModule) {
		load(SerialControllerJSSC.class, debugModule);
	}

	private void load(Class<? extends SerialController> serialController, Class<? extends Module> debugModule) {
		...
		try {
			...
			serialCom = new ComDriver(serialController.newInstance());

			// Load extensions and modules
			if (debugModule != null)
				ModuleLoader.loadModule(debugModule);
			ModuleLoader.loadExternalModules(rAmbilight.class);
